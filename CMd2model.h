/*********************************************
  File:       CMd2model.h
  Purpose:    Class for MD2 object
  class name: CMd2model derived from CObject
  --------------------------------------------
  @Author: Yo
  @Version: 0
 *********************************************/
...
namespace Engine
{
	namespace Graphics
	{
		class CMd2model : public Engine::Component::CRenderingComponent
		{
		public:
			//CMd2model(std::string name, unsigned int id, const std::string s_filename);
			CMd2model(const std::string& s_filename);
			virtual ~CMd2model();
		...
		public:
			bool loadMD2Model(const std::string& s_filename);
