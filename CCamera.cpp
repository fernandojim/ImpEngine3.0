...
CCamera::CCamera(const std::string& name, int h, int w, float aspect) : Engine::Base::CObject(name)
{
...
CCamera::CCamera(const std::string& name, glm::vec3 *look) : Engine::Base::CObject(name)
{
	position = glm::vec3(0.0, 0.0, 0.0);
...
CCamera::CCamera(const std::string& name, glm::vec3 *pos, glm::vec3 *look) : Engine::Base::CObject(name)
{
	position = *pos;
	lookAt = glm::normalize(*look);
...
void CCamera::LookAtNow(const Engine::Entity::CGameObject& object)
{
