...
CFbo::CFbo(FrameBufferType m_type)
{
...
CFbo::CFbo(FrameBufferType m_type, GLuint w, GLuint h)
{
	clean();
...
void CFbo::CreateSBO()
{
	...
	//Generate and bind the frame buffer
	glFramebufferTexture2D(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, GL_TEXTURE_2D, m_uiTextureHandler, 0);
